...
namespace Rivet
{
    ...
    public:
        ...
        void init()
        {
            ...
            const FinalState fs(Cuts::abseta < 5.0 && Cuts::pT > 1000 * MeV);
            declare(fs, "fs");

            const ChargedFinalState cfs(Cuts::abseta < etamax && Cuts::pT > 1000 * MeV);
            declare(cfs, "cfs");
        ...
        void analyze(const Event &event)
        {
            ...
            Particles particles =
                applyProjection<VetoedFinalState>(event, "nonmuons").particlesByPt(Cuts::pT > 1.0 * GeV && Cuts::abseta < etamax);
